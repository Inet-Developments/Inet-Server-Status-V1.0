...
elseif($page == "admins_delete"){
include"admins/admins_delete.php";
}
elseif($page == "admins_edit"){
include"admins/admins_edit.php";
}
elseif($page == "backup"){
...
elseif($page == "servers_delete"){
include"servers/servers_delete.php";
}
elseif($page == "servers_edit"){
include"servers/servers_edit.php";
}
...
<?php include 'template/navigation/main_left.php'; ?>
</div>
</div>
</body>
</html>
